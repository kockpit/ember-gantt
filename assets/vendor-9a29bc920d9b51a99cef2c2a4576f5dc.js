...
return Ember.get(this,"color")&&(e+="background-color:"+Ember.get(this,"color")),Ember.String.htmlSafe(e)}),barTitle:Ember.computed("dateStart","dateEnd",function(){var e=Ember.get(this,"dateStart").toLocaleDateString()||String(Ember.get(this,"dateStart")),n=Ember.get(this,"dateEnd").toLocaleDateString()||String(Ember.get(this,"dateEnd")),r=t.default.diffDays(Ember.get(this,"dateStart"),Ember.get(this,"dateEnd"),!0)
return e&&n?Ember.String.htmlSafe(e+" - "+n+" ("+r+")"):""}),offsetLeft:function(e){var t=e.getBoundingClientRect(),n=window.pageXOffset||document.documentElement.scrollLeft
...
e.__esModule=!0,e.default=Ember.HTMLBars.template({id:"au9I2igS",block:'{"symbols":["&default"],"statements":[[6,"div"],[10,"class","gantt-line-milestone-icon"],[8],[9],[0,"\\n"],[6,"div"],[10,"class","gantt-line-milestone-title"],[8],[0,"\\n"],[4,"if",[[23,1]],null,{"statements":[[0,"    "],[13,1],[0,"\\n\\n"]],"parameters":[]},{"statements":[[0,"      "],[6,"span"],[8],[1,[20,"formattedDate"],false],[9],[1,[20,"title"],false],[0,"\\n\\n"]],"parameters":[]}],[9],[0,"\\n"]],"hasEval":false}',meta:{moduleName:"@kockpit/ember-gantt/templates/components/gantt-milestone.hbs"}})}),define("@kockpit/ember-gantt/templates/components/gantt-timeline",["exports"],function(e){"use strict"
