...
i.days.push({nr:a,date:u.setDate(a),isWeekend:[0,6].indexOf(u.getDay())>=0})}r.push(i),n.setMonth(n.getMonth()+1)}return r}),dateToOffset:function(e,n,r){var i=parseInt(Ember.get(this,"dayWidth"))||0
return n=n||Ember.get(this,"viewStartDate"),r=!Ember.isNone(r)&&r,Ember.isNone(e)||Ember.isNone(n)||"function"!=typeof e.getTime?0:t.default.diffDays(n,e,r)*i},offsetToDate:function(e){var t=Ember.get(this,"viewStartDate"),n=e/(parseInt(Ember.get(this,"dayWidth"))||0),r=t.getTime()+864e5*n
...
if(1===(t=(t=t.uniq()).sort()))return t[0]
...
return n.setDate(n.getDate()+t),n},diffDays:function(e,t,n){var r=Math.floor((t.getTime()-e.getTime())/864e5)
